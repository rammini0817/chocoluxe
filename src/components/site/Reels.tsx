    ...
    <section id="reels" className="relative py-32 lg:py-44">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          <div>
            <span className="text-xs tracking-[0.4em] uppercase text-gold/80">05 — From the Atelier</span>
          ...
          <a href="#" className="text-sm text-gold hover:underline underline-offset-4">@maisoncocoa →</a>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {reels.map((r, i) => (
            <motion.a
              ...
              whileHover={{ y: -6 }}
              className="group relative block aspect-[3/4] rounded-2xl overflow-hidden noise"
            >
              <img
                src={r.img}
                alt={r.caption}
