...
export function CtaFooter() {
  return (
    <footer id="cta" className="relative pt-32 lg:pt-44 pb-12 overflow-hidden">
      ...
      <div
        data-parallax="0.15"
        className="absolute left-1/2 top-1/3 -translate-x-1/2 w-[60vw] h-[60vw] max-w-[700px] max-h-[700px] rounded-full bg-[radial-gradient(circle,oklch(0.78_0.13_78/0.12),transparent_60%)] blur-3xl pointer-events-none"
      />

      <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
        <div className="text-center max-w-3xl mx-auto">
          <span data-reveal className="text-xs tracking-[0.4em] uppercase text-gold/80">Be the first to taste</span>
          <h2 data-reveal className="mt-6 font-display text-5xl md:text-8xl leading-[0.95] tracking-tight">
            Reserve your <br />
          ...
          >
            ...
            <MagneticButton
              type="submit"
              className="rounded-full bg-gold px-7 py-4 text-sm font-medium text-primary-foreground shadow-glow"
            >
              Reserve
            </MagneticButton>
          </form>
